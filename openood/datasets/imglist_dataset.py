...
class ImglistDataset(BaseDataset):
    def __init__(self,
        ...
        print(f"Loaded {len(self.imglist)} images from {imglist_pth}")
        self.data_dir = data_dir_root + data_dir
        self.num_classes = num_classes
        self.preprocessor = preprocessor
        self.transform_image = preprocessor
        assert self.transform_image is not None, 'preprocessor is None'
