...
from .base_trainer_cct import BaseTrainerCCT
from .base_trainer_mlpmixer import BaseTrainerMLPMixer
from .base_trainer_resnet50 import BaseTrainerResnet50
...
def get_trainer(net, train_loader: DataLoader, val_loader: DataLoader,
    ...
    if type(train_loader) is DataLoader:
        trainers = {
            'base': BaseTrainer,
            'base_cct': BaseTrainerCCT,
            'base_mlpmixer': BaseTrainerMLPMixer,
            'base_resnet50': BaseTrainerResnet50,
