...
normalization_dict = {
    ...
    'clothing1M': [[0.7249, 0.6878, 0.6702], [0.2514, 0.2656, 0.2657]],
    'fgvc-aircraft': [[0.4914, 0.4822, 0.4465], [0.2023, 0.1994, 0.2010]],
    'fgvc-cub': [[0.4914, 0.4822, 0.4465], [0.2023, 0.1994, 0.2010]],
}
