...
class ASHNet(nn.Module):
    ...
    def forward_threshold(self, x, percentile, variant=None):
        ...
        if variant == "ash_b":
            ...
            feature = ash_p(feature.view(feature.size(0), -1, 1, 1), percentile)
        elif variant == "ash_rand":
            feature = ash_rand(feature.view(feature.size(0), -1, 1, 1), percentile)
        else:
            raise ValueError
