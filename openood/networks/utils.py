...
from .cct import cct_model_dict
...
def get_network(network_config):
    ...
    elif 'cct' in network_config.name:
        net = cct_model_dict[network_config.model](num_classes=num_classes,
                                                   image_size=network_config.img_size)
        
    elif network_config.name == 'mlpmixer':
        net = MLPMixer(
