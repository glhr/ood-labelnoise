...
from openood.datasets import get_dataloader, get_ood_dataloader, get_feature_dataloader
...
class TestOODPipeline:
    ...
    def run(self):
        ...
        try:
            ...
            # only keep train, val, test in id_loader_dict
            id_loader_dict = {
                k: loader_dict[k]
                for k in ['train', 'val', 'test']
            }
            # only keep ood in ood_loader_dict
            ood_loader_dict = {
                k: loader_dict[k]
                for k in ['ood']
            }
